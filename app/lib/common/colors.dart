...
class TWColor {
  ...
  static const Color fuschia50 = Color(0xfffdf4ff);
  static const Color fuschia100 = Color(0xfffae8ff);
  static const Color fuschia200 = Color(0xfff5d0fe);
  static const Color fuschia300 = Color(0xfff0abfc);
  static const Color fuschia400 = Color(0xffe879f9);
  static const Color fuschia500 = Color(0xffd946ef);
  static const Color fuschia600 = Color(0xffc026d3);
  static const Color fuschia700 = Color(0xffa21caf);
  static const Color fuschia800 = Color(0xff86198f);
  static const Color fuschia900 = Color(0xff701a75);
...
class AppColors {
  ...
  static const Color heading = TWColor.gray800;
  static const Color body = TWColor.gray600;

  static const Color darkDropdownButtonBg = TWColor.zinc800;
  static const Color darkDropdownButtonAccent = TWColor.zinc700;

  static const darkPrimaryColor = TWColor.white;
